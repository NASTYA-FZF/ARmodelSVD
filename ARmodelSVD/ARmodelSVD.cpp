...
// ARmodelSVD.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CARmodelSVDApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CARmodelSVDApp

CARmodelSVDApp::CARmodelSVDApp()
{
...
// Единственный объект CARmodelSVDApp

CARmodelSVDApp theApp;


// Инициализация CARmodelSVDApp

BOOL CARmodelSVDApp::InitInstance()
{
